...
class Booking extends Model {
  ...
  Booking.fromJson(Map<String, dynamic> json) {
    ...
    expiringAt = stringFromJson(json, 'expire_duration');
    ...
    createdAt = dateFromJson(json, 'created_at', defaultValue: null);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.expiringAt != null) {
      data['expire_duration'] = this.expiringAt;
    }
    ...
    if (this.createdAt != null) {
      data['created_at'] = createdAt.toUtc().toString();
    }
    return data;
  }
