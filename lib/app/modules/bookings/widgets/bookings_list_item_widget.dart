...
class BookingsListItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(_booking.expiringAt.isNotEmpty){
      String hoursStr = _booking.expiringAt.split(":")[0];
      String minuteStr = _booking.expiringAt.split(":")[1];
      ...
      timeRemaining = _booking.createdAt.add(Duration(hours: hours, minutes: minutes)).difference(DateTime.now()).inMilliseconds;
