...
class CategoryController extends GetxController {
  ...
  Future getSubCategoriesIds(categoryId) {
  ...
  Future loadEServicesOfCategory(String categoryId,
    ...
    try {
      ...
      List<Category> subCategoryIds = await getSubCategoriesIds(categoryId);
      print('sub category $subCategoryIds');
      categoryId =
          categoryId + ',' + subCategoryIds.map((val) => val.id).join(',');
      // print('Category $subCategoryIds');
      isDone.value = false;
      this.page.value++;
